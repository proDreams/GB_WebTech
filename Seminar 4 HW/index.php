...
$jobs = [
    ...
    [
        "jobName" => "Поломойщик в тц",
        "startDate" => "15.10.2018",
        "endDate" => "05.07.2022",
        "description" => "Надо было всё таки чуть меньше тырить ярлыки.."
    ],
    [
        "jobName" => "Системный администратор",
        "startDate" => "10.10.2014",
        "endDate" => "12.10.2018",
        "description" => "Системный администратор на предприятии. Обязанности: вешать сервак, зависать 1С, тырить ярлыки с рабочего стола бухгалтеров."
    ]
]
                    ...
                    <?php for ($i = 0; $i < count($jobs); $i++): ?>
                        <div class="w3-container">
                            ...
                            <h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i>
                                <?php echo $jobs[$i]['startDate']; ?> - <?php if ($jobs[$i]['endDate'] == '-') {
